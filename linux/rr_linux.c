...
void execute_quantum(Process *p, int quantum) {
    pid_t child = fork();
    if (child == 0) { cpu_intensive_work(quantum); exit(0); }
...
void calculate_metrics(Process p[], int n, double total_time, int cs) {
    ...
    printf("\n========================================================================================\n");
    printf("          PERFORMANCE METRICS (Linux - Round Robin) Actual OS Measurements             \n");
    printf("========================================================================================\n");
    ...
    printf("Time Quantum               = %d seconds\n",TIME_QUANTUM);
    printf("========================================================================================\n");
    printf("Note: Higher context switches vs FCFS/SJF due to time-slicing overhead\n");
    printf("========================================================================================\n");
}
