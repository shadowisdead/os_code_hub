...
void calculate_metrics(Process p[], int n, double total_actual_time, int context_switches) {
    ...
    printf("\n========================================================================================\n");
    printf("               PERFORMANCE METRICS (Windows - FCFS) Actual OS Measurements             \n");
    printf("========================================================================================\n");
    ...
    printf("========================================================================================\n");
    printf("Note: Higher execution time vs Linux due to PowerShell CreateProcess() overhead\n");
    printf("========================================================================================\n");
}
...
int main() {
    ...
    printf("  - Execution Mode   : Kernel-level via CreateProcess() + WaitForSingleObject()\n");
    ...
    for (int i = 0; i < n; i++) {
        ...
        if (processes[i].arrival_time > elapsed)
            Sleep((DWORD)((processes[i].arrival_time - elapsed) * 1000));
